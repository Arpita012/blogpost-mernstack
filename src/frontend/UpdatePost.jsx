...
import './UpdatePost.css'; // Assuming you have an UpdatePost.css file for styling
...
const UpdatePost = () => {
  ...
  const handleUpdatePost = async () => {
    try {
      ...
      const response = await axios.put(`http://localhost:3001/updatepost/${postId}`, updatedPost, {
        headers: {
